...
-- Hard enforcement: rating insert/update only if event has ended and
-- rater had approved join on that event OR rater is host and rated person had approved join.
